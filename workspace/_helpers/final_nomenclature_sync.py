...
1.  **Global Defaults (`settings`)**: This section establishes the baseline parameters for any execution (such as output directories, default logging verbosity, and standard timeouts).
...
with open('modules/jobs2md/README.md', 'r', encoding='utf-8') as f:
    content = f.read()
    # Find the section to replace
    ...
    if new_content != content:
        with open('modules/jobs2md/README.md', 'w', encoding='utf-8') as f:
            f.write(new_content)
        print("Updated modules/jobs2md/README.md example")
