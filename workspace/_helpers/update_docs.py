...
new_nom_to_ai = """  Your task is to maintain a hyper-organized, easily navigable nomenclature dictionary that translates Sandman's universal orchestration variables into the specific parameters used by underlying modules (like JobSpy and reddit2md).
  ...
  2. Clearly list what each standard variable maps to in JobSpy (jobs2md) and reddit2md (reddit2md).
...
This document establishes the unified naming conventions across the Sandman ecosystem. Sandman orchestration translates these universal standard variables down into the specific parameters required by individual modules (like reddit2md for Reddit, or jobs2md using JobSpy). 
